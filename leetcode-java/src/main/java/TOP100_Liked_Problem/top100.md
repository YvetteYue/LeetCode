...
|3|[Longest Substring Without Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters)|[算法思路](./medium/NO3LongesSubstringWithoutRepeatingCharacters.java)|o(n) hash(ascII)+滑动窗口、two pointer|99.9%|Yes|
|5|[Longest Palindromic Substring](https://leetcode.com/problems/longest-palindromic-substring)|[算法思路](./medium/NO5LongestPalindromicSubstring.java)|o(n^2) dp或中心扩展|98%|**TODO Manacher**|
...
|22|[Generate Parentheses](https://leetcode.com/problems/generate-parentheses)|[算法思路](./medium/NO22GenerateParentheses.java)|o(2^n) dfs+剪枝或闭包递归|100%|**TODO 闭包**|
...
|39|[Combination Sum](https://leetcode.com/problems/combination-sum)|[算法思路](./medium/NO39CombinationSum.java)|O(2^n) dfs回溯+剪枝|99.96%|Yes|
|46|[Permutations](https://leetcode.com/problems/permutations)|[算法思路](./medium/NO46Permutations.java)|o(2^n) dfs回溯+剪枝+used访问标记用于去重|99.82%|Yes|
|48|[Rotate Image](https://leetcode.com/problems/rotate-image)|[算法思路]()|
|49|[Group Anagrams](https://leetcode.com/problems/group-anagrams)|[算法思路](./medium/NO49GroupAnagrams.java)|o(nklog(k)) 字符串排序+map或o(nk) 26位字符数组、26个素数乘积|99%|Yes|
...
|98|[Validate Binary Search Tree](https://leetcode.com/problems/validate-binary-search-tree)|[算法思路](./medium/NO98ValidateBinarySearchTree.java)|o(m) 树的中序遍历|100%|Yes|
...
|148|[Sort List](https://leetcode.com/problems/sort-list)|[算法思路](./medium/NO148SortList.java)|o(nlgn) 链表的归并排序或快速排序|97%|**TODO 链表快速排序**|
