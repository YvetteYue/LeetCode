...
|33|[Search in Rotated Sorted Array](https://leetcode.com/problems/search-in-rotated-sorted-array)|[算法思路](./medium/NO33SearchinRotatedSortedArray.java)|O(lgn) 二分 注意连续即可判断二分方向|100%|Yes|
|34|[Find First and Last Position of Element in Sorted Array](https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array)|[算法思路](./medium/NO34FindFirstandLastPositionofElementinSortedArray.java)|o(lgn) 二分(一个求first,一个求last)|100%|Yes|
...
|64|[Minimum Path Sum](https://leetcode.com/problems/minimum-path-sum)|[算法思路](./medium/NO64MinimumPathSum.java)|o(n^2) dp或dfs|99%|Yes|
...
|105|[Construct Binary Tree from Preorder and Inorder Traversal](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inordertraversal)|[算法思路](./medium/NO105ConstructBinarTreefromPreorderandInorderTraversal.java)|
...
|142|[Linked List Cycle II](https://leetcode.com/problems/linked-list-cycle-ii)|[算法思路](./medium/NO142LinkedListCycleII.java)|o(n) 链表判环，注意其实位置可能就是环|100%|Yes|
|148|[**Sort List**](https://leetcode.com/problems/sort-list)|[算法思路](./medium/NO148SortList.java)|o(nlgn) 链表的归并排序或快速排序|99%|Yes|
...
|208|[Implement Trie (Prefix Tree)](https://leetcode.com/problems/implement-trie-prefix-tree)|[算法思路](./medium/NO208ImplementTriePrefixTree.java)|o(n) 链表数组+isEnd|99%|Yes|
|215|[**Kth Largest Element in an Array**](https://leetcode.com/problems/kth-largest-element-in-an-array)|[算法思路](./medium/NO215KthLargestElementinanArray.java)|o(n) quickselect或 堆排序 或优先队列|99%|Yes|
